...
export { v as AlertRepository, a as AuditEventRepository, E as DkimSelectorRepository, b as DomainNoteRepository, q as DomainTagRepository, U as FindingRepository, c as LegacyAccessLogRepository, h as MailEvidenceRepository, D as MismatchReportRepository, r as MonitoredDomainRepository, P as ObservationRepository, l as ProviderBaselineRepository, N as RecordSetRepository, d as RemediationRepository, x as RulesetVersionRepository, f as SavedFilterRepository, g as ShadowComparisonRepository, i as SharedReportRepository, u as SimpleDatabaseAdapter, s as SnapshotRepository, I as SuggestionRepository, w as TemplateOverrideRepository, H as adjudicationEnum, j as alertStatusEnum, _ as alerts, k as auditActionEnum, p as auditEvents, Z as baselineStatusEnum, m as blastRadiusEnum, o as collectionStatusEnum, z as confidenceEnum, A as createAdapterFromConfig, W as createClient, Y as createD1Adapter, G as createD1Client, B as createPostgresAdapter, X as createPostgresClient, V as createSimpleAdapter, F as dkimSelectors, K as domainNotes, L as domainTags, O as domains, Q as fieldComparisonStatusEnum, R as findings, S as fleetReportStatusEnum, T as isDbError, $ as legacyAccessLogs, a0 as legacyToolTypeEnum, a1 as mailEvidence, a2 as mailProviderEnum, a3 as mapDatabaseError, a4 as mismatchReports, a5 as monitoredDomains, a6 as monitoringScheduleEnum, a7 as observations, a8 as parseSSLConfig, a9 as partitionDbResults, aa as probeStatusEnum, ab as probeTypeEnum, ac as providerBaselines, ad as recordSets, ae as remediationPriorityEnum, af as remediationRequests, ag as remediationStatusEnum, ah as resultStateEnum, ai as riskPostureEnum, aj as rulesetVersions, ak as savedFilters, al as selectorConfidenceEnum, am as selectorProvenanceEnum, an as sessions, ao as severityEnum, ap as shadowComparisons, aq as shadowStatusEnum, ar as sharedReportStatusEnum, as as sharedReportVisibilityEnum, at as sharedReports, au as snapshots, av as suggestions, aw as templateOverrides, ax as toNotFoundError, ay as toTenantIsolationError, az as unwrapDbResultOr, aA as users, aB as vantageTypeEnum, aC as zoneManagementEnum } from '../nitro/nitro.mjs';
...
class R {
  ...
  async createResult(e) {
    ...
    return Jd(() => this.repo.create(e), (t) => new ye({ message: t instanceof Error ? t.message : "Failed to create domain", code: "QUERY_FAILED", table: "Domain", operation: "create" }));
  }
  async findOrCreateResult(e) {
    return Jd(() => this.repo.findOrCreate(e), (t) => new ye({ message: t instanceof Error ? t.message : "Failed to find or create domain", code: "QUERY_FAILED", table: "Domain", operation: "findOrCreate" }));
  }
  ...
  async searchByNameResult(e, t) {
    return Jd(() => this.repo.searchByName(e, t), (s) => new ye({ message: s instanceof Error ? s.message : "Search failed", code: "QUERY_FAILED", table: "Domain", operation: "search" }));
  }
  async findAllResult(e, t) {
    return Jd(() => this.repo.findAll(e, t), (s) => new ye({ message: s instanceof Error ? s.message : "Find all failed", code: "QUERY_FAILED", table: "Domain", operation: "findAll" }));
  }
}
function Y(p) {
  return new R(p);
...
class W {
  ...
  async findById(e) {
    return await this.db.selectOne(Co, eq(Co.id, e)) || null;
  }
  async findByTenant(e, t = 100) {
    return (await this.db.selectWhere(Co, eq(Co.tenantId, e))).sort((a, o) => {
  ...
  async create(e) {
    return this.db.insert(Co, e);
  }
  async markProcessing(e) {
    return await this.db.update(Co, { status: "processing", startedAt: /* @__PURE__ */ new Date(), updatedAt: /* @__PURE__ */ new Date() }, eq(Co.id, e)), this.findById(e);
  }
  async complete(e, t, s) {
    return await this.db.update(Co, { status: "completed", summary: t, domainResults: s, completedAt: /* @__PURE__ */ new Date(), updatedAt: /* @__PURE__ */ new Date() }, eq(Co.id, e)), this.findById(e);
  }
  async markFailed(e, t) {
    return await this.db.update(Co, { status: "failed", errorMessage: t, completedAt: /* @__PURE__ */ new Date(), updatedAt: /* @__PURE__ */ new Date() }, eq(Co.id, e)), this.findById(e);
  }
  async delete(e) {
    return await this.db.delete(Co, eq(Co.id, e)), true;
  }
...
class E {
  ...
  async findByDomainResult(e, t) {
    return Jd(() => this.repo.findByDomain(e, t), (s) => new ye({ message: s instanceof Error ? s.message : "Failed to find snapshots", code: "QUERY_FAILED", table: "Snapshot", operation: "findByDomain", identifier: e }));
  }
  ...
  async findRecentByDomainResult(e, t) {
    return Jd(() => this.repo.findRecentByDomain(e, t), (s) => new ye({ message: s instanceof Error ? s.message : "Failed to check recent snapshot", code: "QUERY_FAILED", table: "Snapshot", operation: "findRecentByDomain", identifier: e }));
  }
  async createResult(e) {
    return e.domainId ? Jd(() => this.repo.create(e), (t) => new ye({ message: t instanceof Error ? t.message : "Failed to create snapshot", code: "QUERY_FAILED", table: "Snapshot", operation: "create" })) : Result.err(new ye({ message: "Domain ID is required", code: "CONSTRAINT_VIOLATION", table: "Snapshot", operation: "create" }));
  }
  ...
  async listResult(e) {
    return Jd(() => this.repo.list(e), (t) => new ye({ message: t instanceof Error ? t.message : "Failed to list snapshots", code: "QUERY_FAILED", table: "Snapshot", operation: "list" }));
  }
  async countByDomainResult(e) {
    return Jd(() => this.repo.countByDomain(e), (t) => new ye({ message: t instanceof Error ? t.message : "Failed to count snapshots", code: "QUERY_FAILED", table: "Snapshot", operation: "countByDomain", identifier: e }));
  }
  async findNeedingBackfillResult(e, t) {
    return Jd(() => this.repo.findNeedingBackfill(e, t), (s) => new ye({ message: s instanceof Error ? s.message : "Failed to find backfill candidates", code: "QUERY_FAILED", table: "Snapshot", operation: "findNeedingBackfill" }));
  }
}
function q(p) {
  return new E(p);
...
//# sourceMappingURL=index-B35ZAyYo.mjs.map
