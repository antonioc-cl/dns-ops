 ...
 * Shows recent changes to notes, tags, filters, and template overrides.
 */
    ...
    <div className="flex gap-3">
      ...
      <div className="flex-1 min-w-0">
        ...
        <p className="text-sm text-gray-600 mt-0.5">
          {event.entityType} <span className="font-mono text-xs">{event.entityId.slice(0, 8)}...</span>
        </p>
