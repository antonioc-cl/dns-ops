 ...
 */
export function getProbeSemaphore() {
    if (!_probeSemaphore) {
 ...
 */
export function initProbeSemaphore(permits) {
 ...
 */
export function resetProbeSemaphore(permits = DEFAULT_CONCURRENCY) {
    _probeSemaphore = new Semaphore(permits);
    return _probeSemaphore;
}
