 ...
 */
export async function sendAlertWebhook(webhookUrl, payload, signal) {
 ...
 */
export function buildWebhookPayload(alert, baseUrl) {
 ...
 */
export async function sendAlertNotification(alertId, webhookUrl, alertData, db, baseUrl) {
    // Build the payload
